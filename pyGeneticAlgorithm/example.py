...
from GeneticAlgorithm import algorithm as ga
...
ga.setting_for_file(None, None)


ga.setting_for_selection(pop_size=200, elitism=0.05, by_rank=0.08, by_fitness=0.08, by_tournament=0.12)

# if proba is 0.5 that mean that all selected individual have 0.5 to mutate
ga.setting_mutation(mutation_crossover=0, mutation_inverse=0, mutation_modify=0.5, modify_range=0.5, modify_number_type=float)


# evolute by using 3 different ways:

# make x evolution to make a mean of the different value on the graph
# ga.multiple_evolutions(100, 10)

# evolute x generation:
# ga.evolute(200)

# evolute automatically with some param
ga.evolute(-1, auto_difference=0.01, auto_min_score=388)
